...
X_train, Y_train = read_csv('C:/projects/emojify/Emojify/data/train_emoji.csv')
X_test, Y_test = read_csv('C:/projects/emojify/Emojify/data/tesss.csv')
...
word_to_index, index_to_word, word_to_vec_map = read_glove_vecs('C:/projects/emojify/Emojify/data/glove.6B.50d.txt')
